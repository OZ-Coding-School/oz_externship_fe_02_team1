...
export { default as LogDetailMain } from '@components/study-log-detail/LogDetailMain'
export { default as LogDetailAttachments } from '@components/study-log-detail/LogDetailAttachments'
